...
import { XIcon, SaveIcon, CheckCircleIcon, WriteIcon, MapIcon, BookOpenIcon, LayoutDashboardIcon } from './icons';
...
const SceneEditModal: React.FC<SceneEditModalProps> = ({ scene, allCharacters, onSave, onClose }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            <div className="glass-panel bg-brand-surface/95 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col border border-white/10">
                ...
                <div className="flex items-center justify-between p-5 border-b border-white/10">
                    <h2 className="text-xl font-bold text-brand-secondary font-serif flex items-center gap-2">
                        Edit Scene: {title}
                    </h2>
                ...
                {/* Tabs */}
                <div className="flex items-center border-b border-white/10 px-5 bg-brand-bg/30">
                    <button 
