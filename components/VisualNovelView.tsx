...
import { ChevronLeftIcon, ChevronRightIcon, ImageIcon, UserIcon, WandSparklesIcon } from './icons';
    ...
    return (
        <div className="flex flex-col h-full max-h-[calc(100vh-6rem)] gap-4 p-4 lg:p-0">
            ...
            <div className="flex-grow relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-black group">
                ...
                <div className="absolute bottom-6 left-4 right-4 lg:left-12 lg:right-12 min-h-[140px] bg-brand-surface/90 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col">
                     <div className="flex justify-between items-start mb-2">
                        <h3 className="text-xl font-serif font-bold text-brand-secondary drop-shadow-sm">{currentScene.title}</h3>
